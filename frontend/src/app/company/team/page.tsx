...
export default function CompanyTeamPage() {
  ...
  <DashboardLayout sidebar={<OrgSidebarNav title="Company Panel" subtitle="Manage your team" items={navItems} />} bottomNav={<OrgBottomNav items={navItems} /> }>
        <div className='space-y-6'>
          <div>
            <h1 className='text-3xl font-bold tracking-tight'>Team</h1>
            <p className='text-muted-foreground'>Manage company users (implementation pending)</p>
          </div>
          <div className='rounded-md border p-6 text-sm text-muted-foreground'>Team management UI coming soon.</div>
        </div>
      </DashboardLayout>
    </ProtectedRoute>
  );
